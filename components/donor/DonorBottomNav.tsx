...
export default function DonorBottomNav() {
  ...
  const getActiveKey = () => {
    if (pathname.includes('/donor/home')) return 'home';
    if (pathname.includes('/donor/history')) return 'history';
    if (pathname.includes('/donor/recurring')) return 'recurring';
    if (pathname.includes('/donor/profile')) return 'profile';
    return 'home';
  };
